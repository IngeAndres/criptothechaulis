...
public class TipooperacionFacadeREST extends AbstractFacade<Tipooperacion> {
    ...
    public void create(Tipooperacion entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Tipooperacion entity) {
        super.edit(entity);
    }
    ...
    public Tipooperacion find(@PathParam("id") Integer id) {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Tipooperacion> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
