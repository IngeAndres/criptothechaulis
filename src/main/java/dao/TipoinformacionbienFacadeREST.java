...
public class TipoinformacionbienFacadeREST extends AbstractFacade<Tipoinformacionbien> {
    ...
    public void create(Tipoinformacionbien entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Tipoinformacionbien entity) {
        super.edit(entity);
    }
    ...
    public Tipoinformacionbien find(@PathParam("id") Integer id) {
    ...
    @Override
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Tipoinformacionbien> findAll() {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Tipoinformacionbien> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
